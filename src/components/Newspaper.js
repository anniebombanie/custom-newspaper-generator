  ...
  render() {
    return (
      <div className="newspaper">
        <h2>
          <span>The</span> {this.props.city}
          {this.props.getRandomItem(this.state.newspaperTitle)}
        </h2>
        ...
        <div className="container-newspaper-content">
          ...
          <div className="container-txt">
            ...
            <p>
              Doctors are astounded by the birth of {this.props.name}.
              <span className="italic">
                "Cutest baby I've ever seen in my life!"
              </span>
              gushes a besotted nurse. Parents are doing well.
            </p>
          </div>
        </div>
      </div>
